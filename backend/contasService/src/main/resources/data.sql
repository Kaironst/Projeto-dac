...
insert into item_historico (tipo, valor_movimentacao, data_hora ,conta_origem_id, conta_destino_id)
  select 0 , 1000.00, '2020-01-01 10:00:00', 
    (select id from conta where cliente = (select id from users_schema.cliente where cpf = '12912861012')),
    null 
...
insert into item_historico (tipo, valor_movimentacao, data_hora ,conta_origem_id, conta_destino_id)
  select 2, 1700.00, '2020-01-20 12:00:00', 
    (select id from conta where cliente = (select id from users_schema.cliente where cpf =  '12912861012')),
    (select id from conta where cliente = (select id from users_schema.cliente where cpf =  '09506382000'))
...
insert into item_historico (tipo, valor_movimentacao, data_hora ,conta_origem_id, conta_destino_id)
  select 0, 1000.00, '2025-05-05', 
    (select id from conta where cliente = (select id from users_schema.cliente where cpf =  '85733854057')),
    null 
...
insert into item_historico (tipo, valor_movimentacao, data_hora ,conta_origem_id, conta_destino_id)
  select 0, 150000.00, '2025-06-01', 
    (select id from conta where cliente = (select id from users_schema.cliente where cpf =  '58872160006')),
    null 
  where not exists ( select 1 from item_historico where data_hora = '2025-06-01');

insert into item_historico (tipo, valor_movimentacao, data_hora ,conta_origem_id, conta_destino_id)
  select 0, 1500.00, '2025-07-01', 
    (select id from conta where cliente = (select id from users_schema.cliente where cpf =  '76179646090')),
    null 
